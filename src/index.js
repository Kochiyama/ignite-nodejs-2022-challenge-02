...
function checksTodoExists(request, response, next) {
  ...
  const existentTodo = existentUser.todos.find((todo) => todo.id === id);
...
function findUserById(request, response, next) {
  ...
  const existentUser = users.find((user) => user.id === id);
